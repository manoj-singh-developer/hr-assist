(function() {
  ...
  function hraTechnologyProject() {
    return {
      ...
      templateUrl: rootTemplatePath + '/project/views/projectTechnology.view.html'
    };
  }
  ...
  projectTechnologyController.$inject = ['Technology', 'autocompleteService', '$rootScope', '$scope'];

  function projectTechnologyController(Technology, autocompleteService, $rootScope, $scope) {
